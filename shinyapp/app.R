                 ...
                 tabPanel("Map View",
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              br(),
                              br(),
                              img(src = "psp-logo.png", width = "100%"),
                              #HTML("<img src = 'psp-logo.png' width = '100%'/>"),
                              br(),
                              br(),
                              img(src = "gsro-logo.png", width = "100%"),
                              #HTML("<img src = 'gsro-logo.png' width = '100%'/>"),
                              br(),
                              br(),
                              img(src = "doe-logo.png", width = "100%"),
                              #HTML("<img src = 'doe-logo.png' width = '100%'/>"),
                              br(),
                              br(),
                              img(src = "ischool-logo.png", width = "100%"),
                              #HTML("<img src = 'ischool-logo.png' width = '100%'/>"),
                              br(),
                              br(),
                              img(src = "odl-logo.png", width = "100%"),
